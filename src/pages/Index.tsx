    ...
    <PublicLayout>
      ...
      <section className="relative min-h-[80vh] flex items-center overflow-hidden">
        {settingsLoading ? (
          ...
          <div className="absolute inset-0 bg-cover bg-center bg-no-repeat" style={{ backgroundImage: `url(${settings.cover_image_url})` }}>
          ...
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {enabledFeatureTags.map((tag, index) => {
                ...
                return (
                  <div key={tag.id} className="text-center p-6 rounded-2xl card-gradient shadow-card animate-slide-up" style={{ animationDelay: `${index * 0.1}s` }}>
        ...
        <section className="py-16 bg-card">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              <h2 className="font-display text-3xl font-bold text-foreground mb-4">Promociones Especiales</h2>
              <p className="text-muted-foreground">No te pierdas nuestras ofertas exclusivas</p>
            </div>
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="font-display text-3xl md:text-4xl font-bold text-foreground mb-4">Nuestros Servicios</h2>
            <p className="text-muted-foreground max-w-xl mx-auto">Descubre nuestra variedad de servicios de manicura profesional</p>
          </div>

          {servicesLoading ? (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[1, 2, 3].map(i => <div key={i} className="aspect-[4/3] rounded-lg bg-muted animate-pulse" />)}
            </div>
          ) : (
            <>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              {activeServices.length === 0 && (
                <div className="text-center py-12">
                  <p className="text-muted-foreground">Próximamente agregaremos nuestros servicios</p>
                </div>
              )}
              {activeServices.length > 6 && (
                <div className="text-center mt-10">
                  <Link to={`${basePath}/servicios`}>
                    <Button variant="outline" size="lg">Ver todos los servicios</Button>
                  </Link>
                </div>
              )}
            </>
      ...
      <section className="py-20 hero-gradient">
        <div className="container mx-auto px-4 text-center">
          <h2 className="font-display text-3xl md:text-4xl font-bold text-foreground mb-6">¿Lista para lucir unas uñas increíbles?</h2>
          <p className="text-muted-foreground mb-8 max-w-xl mx-auto">Reserva tu cita hoy y déjate consentir por profesionales</p>
          <Link to={`${basePath}/reservar`}>
